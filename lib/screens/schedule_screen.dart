      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: ListTile(
            ...
            title: Text(event["title"] ?? '', style: theme.textTheme.titleLarge),
            subtitle: Text('${event["time"]} - ${event["stage"]}', style: theme.textTheme.bodyMedium),
            trailing: Icon(Icons.arrow_forward_ios_rounded, color: theme.colorScheme.secondary, size: 18),
            onTap: () {
